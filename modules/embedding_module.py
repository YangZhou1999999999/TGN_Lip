...
class IdentityEmbedding(EmbeddingModule):
  def compute_embedding(self, memory, source_nodes,  timestamps, n_layers, flag=True, n_neighbors=20, time_diffs=None,
                        use_time_proj=True):
...
class GraphEmbedding(EmbeddingModule):
  ...
  def compute_embedding(self, memory, source_nodes, timestamps, n_layers, flag=True, n_neighbors=20, time_diffs=None,
    ...
    if n_layers == 0:
      ...
      if flag == True:
        source_node_conv_embeddings, L1 = self.compute_embedding(memory,
                                                            source_nodes,
                                                            timestamps,
                                                            n_layers=n_layers - 1,
      ...
      # source_embedding, norm = self.aggregate(n_layers, source_node_conv_embeddings,
      ...
      #                                   flag=flag)
      if flag == True:
        source_embedding, L2 = self.aggregate(n_layers, source_node_conv_embeddings,
                                          source_nodes_time_embedding,
                                          neighbor_embeddings,
                                          edge_time_embeddings,
                                          edge_features,
                                          mask,
                                          flag=flag)
        return source_embedding, norm*L2
      else:
      ...
      # return source_embedding, norm

  def aggregate(self, n_layers, source_node_features, source_nodes_time_embedding,
                neighbor_embeddings,
                edge_time_embeddings, edge_features, mask,flag):
    return NotImplemented
...
class GraphAttentionEmbedding(GraphEmbedding):
  def __init__(self, node_features, edge_features, memory, neighbor_finder, time_encoder, n_layers,
               n_node_features, n_edge_features, n_time_features, embedding_dimension, device,
               n_heads=2, dropout=0.1, use_memory=True, coefficient=0.1):
  ...
  def aggregate(self, n_layer, source_node_features, source_nodes_time_embedding,
    ...
    if flag == True:
      source_embedding, _, norm = attention_model(source_node_features,
                                            source_nodes_time_embedding,
                                            neighbor_embeddings,
                                            edge_time_embeddings,
                                            edge_features,
...
def get_embedding_module(module_type, node_features, edge_features, memory, neighbor_finder,
                         ...
                         embedding_dimension, device, coefficient=0.1,
  ...
  if module_type == "graph_attention":
    return GraphAttentionEmbedding(node_features=node_features,
                                    ...
                                    embedding_dimension=embedding_dimension,
                                    device=device,
                                    n_heads=n_heads, dropout=dropout, use_memory=use_memory, coefficient=coefficient)
